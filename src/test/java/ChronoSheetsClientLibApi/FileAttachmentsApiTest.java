...
public class FileAttachmentsApiTest {
     ...
     */
    @Test
    public void fileAttachmentsGetFileAttachmentByIdTest() throws ApiException {
        Integer fileAttachmentId = null;
        String xChronosheetsAuth = null;
        CSApiResponseTimesheetFileAttachment response = api.fileAttachmentsGetFileAttachmentById(fileAttachmentId, xChronosheetsAuth);
