...
public class OrganisationGroupsApiTest {
     ...
     */
    @Test
    public void organisationGroupsDeleteOrganisationGroupTest() throws ApiException {
        Integer organisationGroupId = null;
        String xChronosheetsAuth = null;
        CSApiResponseBoolean response = api.organisationGroupsDeleteOrganisationGroup(organisationGroupId, xChronosheetsAuth);
