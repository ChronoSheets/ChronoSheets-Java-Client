...
import ChronoSheetsClient.auth.HttpBearerAuth;
import ChronoSheetsClient.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "https://api.chronosheets.com";
    ...
    public ApiClient() {
        ...
        authentications.put("x-chronosheets-auth", new ApiKeyAuth("header", "x-chronosheets-auth"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.chronosheets.com
