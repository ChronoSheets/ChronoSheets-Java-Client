...
public class ApiResponseListInt32 {
  ...
  public ApiResponseListInt32 data(List<Integer> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListInt32 addDataItem(Integer dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public ApiResponseListInt32 status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListInt32 message(String message) {
