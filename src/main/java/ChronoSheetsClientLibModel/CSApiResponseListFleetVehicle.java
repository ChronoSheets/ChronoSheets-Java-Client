...
public class CSApiResponseListFleetVehicle {
  ...
  public CSApiResponseListFleetVehicle data(List<CSFleetVehicle> data) {
    this.data = data;
    return this;
  }

  public CSApiResponseListFleetVehicle addDataItem(CSFleetVehicle dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<CSFleetVehicle>();
    }
  ...
  **/
  ...
  public CSApiResponseListFleetVehicle status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CSApiResponseListFleetVehicle message(String message) {
