...
public class ApiResponseUserProfile {
  ...
  public ApiResponseUserProfile data(UserProfile data) {
  ...
  **/
  ...
  public ApiResponseUserProfile status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseUserProfile message(String message) {
