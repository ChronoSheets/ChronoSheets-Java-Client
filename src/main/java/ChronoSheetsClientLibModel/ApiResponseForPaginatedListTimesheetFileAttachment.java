...
public class ApiResponseForPaginatedListTimesheetFileAttachment {
  ...
  public ApiResponseForPaginatedListTimesheetFileAttachment totalSetCount(Integer totalSetCount) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListTimesheetFileAttachment data(List<TimesheetFileAttachment> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseForPaginatedListTimesheetFileAttachment addDataItem(TimesheetFileAttachment dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<TimesheetFileAttachment>();
    }
  ...
  **/
  ...
  public ApiResponseForPaginatedListTimesheetFileAttachment status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListTimesheetFileAttachment message(String message) {
