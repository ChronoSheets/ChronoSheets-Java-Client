...
public class ApiResponseForPaginatedListTrip {
  ...
  public ApiResponseForPaginatedListTrip totalSetCount(Integer totalSetCount) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListTrip data(List<Trip> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseForPaginatedListTrip addDataItem(Trip dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Trip>();
    }
  ...
  **/
  ...
  public ApiResponseForPaginatedListTrip status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListTrip message(String message) {
