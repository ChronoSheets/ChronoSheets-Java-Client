...
public class ApiResponseForPaginatedListRawReportItem {
  ...
  public ApiResponseForPaginatedListRawReportItem totalSetCount(Integer totalSetCount) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListRawReportItem data(List<RawReportItem> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseForPaginatedListRawReportItem addDataItem(RawReportItem dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<RawReportItem>();
    }
  ...
  **/
  ...
  public ApiResponseForPaginatedListRawReportItem status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListRawReportItem message(String message) {
