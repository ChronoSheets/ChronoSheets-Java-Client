...
public class CSApiResponseUserProfile {
  ...
  public CSApiResponseUserProfile data(CSUserProfile data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public CSApiResponseUserProfile status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CSApiResponseUserProfile message(String message) {
