...
public class ApiResponseListClient {
  ...
  public ApiResponseListClient data(List<Client> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListClient addDataItem(Client dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public ApiResponseListClient status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListClient message(String message) {
