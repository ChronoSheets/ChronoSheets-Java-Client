...
public class ApiResponseFleetVehicle {
  ...
  public ApiResponseFleetVehicle data(FleetVehicle data) {
  ...
  **/
  ...
  public ApiResponseFleetVehicle status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseFleetVehicle message(String message) {
