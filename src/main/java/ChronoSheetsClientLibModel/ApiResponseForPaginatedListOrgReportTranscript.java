...
public class ApiResponseForPaginatedListOrgReportTranscript {
  ...
  public ApiResponseForPaginatedListOrgReportTranscript totalSetCount(Integer totalSetCount) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListOrgReportTranscript data(List<OrgReportTranscript> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseForPaginatedListOrgReportTranscript addDataItem(OrgReportTranscript dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<OrgReportTranscript>();
    }
  ...
  **/
  ...
  public ApiResponseForPaginatedListOrgReportTranscript status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListOrgReportTranscript message(String message) {
