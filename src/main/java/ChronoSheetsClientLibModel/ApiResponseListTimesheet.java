...
public class ApiResponseListTimesheet {
  ...
  public ApiResponseListTimesheet data(List<Timesheet> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListTimesheet addDataItem(Timesheet dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Timesheet>();
    }
  ...
  **/
  ...
  public ApiResponseListTimesheet status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListTimesheet message(String message) {
