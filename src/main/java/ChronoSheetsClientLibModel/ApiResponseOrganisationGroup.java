...
public class ApiResponseOrganisationGroup {
  ...
  private OrganisationGroup data;
  ...
  public ApiResponseOrganisationGroup data(OrganisationGroup data) {
  ...
  **/
  ...
  public ApiResponseOrganisationGroup status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseOrganisationGroup message(String message) {
