...
public class ApiResponseForPaginatedListExtendedGeofence {
  ...
  public ApiResponseForPaginatedListExtendedGeofence totalSetCount(Integer totalSetCount) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListExtendedGeofence data(List<ExtendedGeofence> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseForPaginatedListExtendedGeofence addDataItem(ExtendedGeofence dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<ExtendedGeofence>();
    }
  ...
  **/
  ...
  public ApiResponseForPaginatedListExtendedGeofence status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListExtendedGeofence message(String message) {
