...
public class ApiResponseListTimesheetTask {
  ...
  public ApiResponseListTimesheetTask data(List<TimesheetTask> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListTimesheetTask addDataItem(TimesheetTask dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<TimesheetTask>();
    }
  ...
  **/
  ...
  public ApiResponseListTimesheetTask status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListTimesheetTask message(String message) {
