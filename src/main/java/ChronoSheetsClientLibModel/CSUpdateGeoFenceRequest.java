...
public class CSUpdateGeoFenceRequest {
  ...
  public CSUpdateGeoFenceRequest geofenceId(Integer geofenceId) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest fenceCoordinates(List<CSBasicCoordinate> fenceCoordinates) {
    this.fenceCoordinates = fenceCoordinates;
    return this;
  }

  public CSUpdateGeoFenceRequest addFenceCoordinatesItem(CSBasicCoordinate fenceCoordinatesItem) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest triggerJobCodeId(Integer triggerJobCodeId) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest triggerTaskId(Integer triggerTaskId) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest sendAlertToOrgGroupId(Integer sendAlertToOrgGroupId) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest alertSettings(AlertSettingsEnum alertSettings) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest triggerSettings(TriggerSettingsEnum triggerSettings) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest startTimeHour(Integer startTimeHour) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest startTimeMinute(Integer startTimeMinute) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest endTimeHour(Integer endTimeHour) {
  ...
  **/
  ...
  public CSUpdateGeoFenceRequest endTimeMinute(Integer endTimeMinute) {
