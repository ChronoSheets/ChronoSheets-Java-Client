...
public class ApiResponseListFleetSummaryReportItem {
  ...
  public ApiResponseListFleetSummaryReportItem data(List<FleetSummaryReportItem> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListFleetSummaryReportItem addDataItem(FleetSummaryReportItem dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<FleetSummaryReportItem>();
    }
  ...
  **/
  ...
  public ApiResponseListFleetSummaryReportItem status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListFleetSummaryReportItem message(String message) {
