...
public class CSApiResponseFleetVehicle {
  ...
  public CSApiResponseFleetVehicle data(CSFleetVehicle data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public CSApiResponseFleetVehicle status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CSApiResponseFleetVehicle message(String message) {
