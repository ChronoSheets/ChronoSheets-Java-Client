...
public class CsApiOrganisationGroup {
  ...
  public CsApiOrganisationGroup id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public CsApiOrganisationGroup organisationId(Integer organisationId) {
  ...
  **/
  ...
  public CsApiOrganisationGroup organisationGroupName(String organisationGroupName) {
  ...
  **/
  ...
  public CsApiOrganisationGroup isDeleted(Boolean isDeleted) {
