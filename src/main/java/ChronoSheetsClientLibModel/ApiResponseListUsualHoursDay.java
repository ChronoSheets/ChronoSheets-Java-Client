...
public class ApiResponseListUsualHoursDay {
  ...
  public ApiResponseListUsualHoursDay data(List<UsualHoursDay> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListUsualHoursDay addDataItem(UsualHoursDay dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<UsualHoursDay>();
    }
  ...
  **/
  ...
  public ApiResponseListUsualHoursDay status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListUsualHoursDay message(String message) {
