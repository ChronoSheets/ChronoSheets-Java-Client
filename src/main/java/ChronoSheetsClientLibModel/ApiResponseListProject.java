...
public class ApiResponseListProject {
  ...
  public ApiResponseListProject data(List<Project> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListProject addDataItem(Project dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public ApiResponseListProject status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListProject message(String message) {
