...
public class ApiResponseTimesheetTask {
  ...
  public ApiResponseTimesheetTask data(TimesheetTask data) {
  ...
  **/
  ...
  public ApiResponseTimesheetTask status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseTimesheetTask message(String message) {
