...
public class ApiResponseUserForManagement {
  ...
  private UserForManagement data;
  ...
  public ApiResponseUserForManagement data(UserForManagement data) {
  ...
  **/
  ...
  public ApiResponseUserForManagement status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseUserForManagement message(String message) {
