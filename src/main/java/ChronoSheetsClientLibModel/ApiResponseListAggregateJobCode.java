...
public class ApiResponseListAggregateJobCode {
  ...
  public ApiResponseListAggregateJobCode data(List<AggregateJobCode> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListAggregateJobCode addDataItem(AggregateJobCode dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<AggregateJobCode>();
    }
  ...
  **/
  ...
  public ApiResponseListAggregateJobCode status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListAggregateJobCode message(String message) {
