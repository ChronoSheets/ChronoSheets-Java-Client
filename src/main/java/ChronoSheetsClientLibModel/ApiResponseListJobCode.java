...
public class ApiResponseListJobCode {
  ...
  public ApiResponseListJobCode data(List<JobCode> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListJobCode addDataItem(JobCode dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<JobCode>();
    }
  ...
  **/
  ...
  public ApiResponseListJobCode status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListJobCode message(String message) {
