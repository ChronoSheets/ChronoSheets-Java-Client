...
public class ApiResponseListFleetVehicle {
  ...
  public ApiResponseListFleetVehicle data(List<FleetVehicle> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseListFleetVehicle addDataItem(FleetVehicle dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<FleetVehicle>();
    }
  ...
  **/
  ...
  public ApiResponseListFleetVehicle status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseListFleetVehicle message(String message) {
