...
public class CSApiResponseForPaginatedListTrip {
  ...
  public CSApiResponseForPaginatedListTrip totalSetCount(Integer totalSetCount) {
  ...
  **/
  ...
  public CSApiResponseForPaginatedListTrip data(List<CSTrip> data) {
    this.data = data;
    return this;
  }

  public CSApiResponseForPaginatedListTrip addDataItem(CSTrip dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<CSTrip>();
    }
  ...
  **/
  ...
  public CSApiResponseForPaginatedListTrip status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CSApiResponseForPaginatedListTrip message(String message) {
