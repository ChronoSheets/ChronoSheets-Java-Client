...
public class ApiResponseForPaginatedListOrgReportTrip {
  ...
  public ApiResponseForPaginatedListOrgReportTrip totalSetCount(Integer totalSetCount) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListOrgReportTrip data(List<OrgReportTrip> data) {
    
    this.data = data;
    return this;
  }

  public ApiResponseForPaginatedListOrgReportTrip addDataItem(OrgReportTrip dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<OrgReportTrip>();
    }
  ...
  **/
  ...
  public ApiResponseForPaginatedListOrgReportTrip status(StatusEnum status) {
  ...
  **/
  ...
  public ApiResponseForPaginatedListOrgReportTrip message(String message) {
