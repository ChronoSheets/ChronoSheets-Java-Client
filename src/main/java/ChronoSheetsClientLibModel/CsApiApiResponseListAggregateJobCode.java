...
public class CsApiApiResponseListAggregateJobCode {
  ...
  public CsApiApiResponseListAggregateJobCode data(List<CsApiAggregateJobCode> data) {
    this.data = data;
    return this;
  }

  public CsApiApiResponseListAggregateJobCode addDataItem(CsApiAggregateJobCode dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<CsApiAggregateJobCode>();
    }
  ...
  **/
  ...
  public CsApiApiResponseListAggregateJobCode status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CsApiApiResponseListAggregateJobCode message(String message) {
