...
public class OrganisationGroupsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call organisationGroupsDeleteOrganisationGroupCall(Integer organisationGroupId, String xChronosheetsAuth, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call organisationGroupsDeleteOrganisationGroupValidateBeforeCall(Integer organisationGroupId, String xChronosheetsAuth, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = organisationGroupsDeleteOrganisationGroupCall(organisationGroupId, xChronosheetsAuth, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CSApiResponseBoolean organisationGroupsDeleteOrganisationGroup(Integer organisationGroupId, String xChronosheetsAuth) throws ApiException {
        ApiResponse<CSApiResponseBoolean> resp = organisationGroupsDeleteOrganisationGroupWithHttpInfo(organisationGroupId, xChronosheetsAuth);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CSApiResponseBoolean> organisationGroupsDeleteOrganisationGroupWithHttpInfo(Integer organisationGroupId, String xChronosheetsAuth) throws ApiException {
        com.squareup.okhttp.Call call = organisationGroupsDeleteOrganisationGroupValidateBeforeCall(organisationGroupId, xChronosheetsAuth, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call organisationGroupsDeleteOrganisationGroupAsync(Integer organisationGroupId, String xChronosheetsAuth, final ApiCallback<CSApiResponseBoolean> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = organisationGroupsDeleteOrganisationGroupValidateBeforeCall(organisationGroupId, xChronosheetsAuth, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CSApiResponseBoolean>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
